...
public class Deserialize_Type
{
    ...
    public Deserialize_Type()
    {
        ...
        Mock.Get(_contextFactory).Setup(f => f.Get(_type, _text)).Returns(_context);
    ...
    {
        var result = _deserializer.Deserialize(_type, _text);
