...
public class DeserializeIntPropertyMessage : IClassFixture<ServiceProviderFixture>
{
    private readonly ITextSerializer _textSerializer;

    public DeserializeIntPropertyMessage(ServiceProviderFixture fixture)
    {
    ...
    {
        {
            $"<DeserializeIntPropertyMessage|123#CRC>",
            new()
            {
                MessageId = nameof(DeserializeIntPropertyMessage),
                Property1 = 123,
            }
        },
    };
